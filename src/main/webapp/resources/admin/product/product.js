...
function go_save(contextPath) 
{
	...
	if (theForm.kind.value == '') {
		...
		theForm.action = contextPath + "/adminProduct/admin_product_write";
...
{
	var theForm = document.frm;
	theForm.action = contextPath + "/adminProduct/admin_product_list";
	theForm.submit();
}
...
function go_detail(tpage, pseq, contextPath) {
	...
	theForm.action =  contextPath + "/adminProduct/admin_product_detail?tpage=" +
	                  tpage+"&pseq="+pseq;
...
function go_wrt(contextPath) {
	var theForm = document.frm;
	theForm.action = contextPath + "/adminProduct/admin_product_write_form";
	theForm.submit();
}
// **************** productDetail.jsp
function go_list(tpage, contextPath) {
	...
	theForm.action = contextPath + "/adminProduct/admin_product_list?tpage=" + tpage;
	theForm.submit();
}
// **************** productDetail.jsp
function go_mod(tpage, pseq, contextPath) {
	...
	theForm.action = contextPath + "/adminProduct/admin_product_update_form?tpage=" + 
		              tpage+"&pseq="+pseq;
	theForm.submit();
}
...
//			theForm.seq.value = pseq;
			...
			theForm.action = contextPath + "/adminProduct/admin_product_update";
			theForm.submit();
		}
	}
}
...
function go_mod_mov(tpage, pseq, contextPath) {
	var theForm = document.frm;
	theForm.action = contextPath + '/adminProduct/admin_product_detail?tpage=' + tpage + "&pseq=" + pseq;
	theForm.submit();
}
