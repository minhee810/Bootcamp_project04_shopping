...
<script type="text/javascript">
	function go_search(contextPath) {
		document.frm.action = contextPath + "/adminMembers/admin_member_list";
		document.frm.submit();
	}
</script>
...
<article>
	...
	<form name="frm" method="post">
		<table style="float: right;">
			<tr>
				<td>회원 이름 
				<input type="text" name="key"> <input class="btn" type="button" value="검색" onclick="go_search('${contextPath}')">
				</td>
			</tr>
		</table>
		<br>
