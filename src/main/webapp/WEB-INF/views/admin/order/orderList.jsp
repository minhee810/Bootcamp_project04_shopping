...
<script type="text/javascript">
	function go_order_save(contextPath) {
		var count = 0;
		...
		if (count == 0) {
			...
			document.frm.action = contextPath + "/adminOrder/admin_order_save";
			document.frm.submit();
		}
	}
	...
	function go_search(contextPath) {
		...
		theForm.action = contextPath + "/adminOrder/admin_order_list";
		theForm.submit();
	}
</script>
<article>
	...
	<form name="frm" method="post">
		<table style="float: right;">
			<tr>
				...
				<input class="btn" type="button" value="검색" onclick="go_search('${contextPath}')">
				</td>
			</tr>
		</table>
		<br>
		...
		<input type="button" class="btn" style="width: 200px"
			value="주문처리(입금확인)" onClick="go_order_save('${contextPath}')">
	</form>
</article>
