...
<%@ include file="/resources/mypage/sub_img.html"%> 
<%@ include file="/resources/mypage/sub_menu.jsp" %>
  ...
  <article>
    ...
    <form name="formm" method="post">
      ...
      <tr>  
        ...
        <td> <a href="${contextPath}/order/order_detail?oseq=${orderVO.oseq}"> 조회 </a></td>
      </tr>
      </c:forEach>
      </table>   
